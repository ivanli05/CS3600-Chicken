...
class SearchEngine:
    ...
    Enhanced with better move ordering and time management.
    """
    ...
    def search(
        ...
        score, best_move = self._minimax(
            ...
            enemy_egg_locations=enemy_egg_locations
        )
    ...
    def _minimax(
        ...
        Args:
            ...
            enemy_egg_locations: Set of locations where enemy has laid eggs
        ...
        ordered_moves = self._order_moves(
            ...
            visited_squares, recent_positions, blocked_locations, enemy_egg_locations
        )

        if maximizing:
            return self._maximize(
                board, ordered_moves, depth, alpha, beta,
                time_left, trapdoor_tracker, visited_squares, 
                recent_positions, blocked_locations, enemy_egg_locations
            )
        else:
    ...
    def _maximize(
        ...
        moves_to_search = moves[:min(15, len(moves))]
        ...
        for move in moves_to_search:
            try:
                ...
                score, _ = self._minimax(
                    ...
                    time_left - 0.01, trapdoor_tracker, visited_squares,
                    recent_positions, blocked_locations, enemy_egg_locations
                )
                forecast.reverse_perspective()
    ...
    def _order_moves(
        ...
        for move in moves:
            ...
            # 3. Move type priority: Egg > Turd > Plain (MAXIMUM EMPHASIS!)
            if move[1] == MoveType.EGG:
                score += 4000.0  # Very strong priority for egg moves!
            elif move[1] == MoveType.TURD:
                score += 600.0

            # 4. Positional evaluation (includes enemy egg avoidance and corner seeking)
            score += self.evaluator.quick_evaluate_move(
                move, board, trapdoor_tracker, visited_squares, 
                recent_positions, blocked_locations, enemy_egg_locations
            )
