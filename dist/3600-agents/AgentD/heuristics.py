...
class MoveEvaluator:
    ...
    def quick_evaluate_move(
        ...
        if move_type == MoveType.PLAIN:
            ...
            if visited_squares is None or new_loc not in visited_squares:
                ...
                if accessible_corners:
                    ...
                    # Bonus for moving toward accessible corners (the right corners for this chicken)
        ...
        if accessible_corners:
            ...
            # STRONGER bonuses for moving toward accessible corners
            ...
            # EXTRA BONUS: If this move is actually AT an accessible corner, huge bonus!
